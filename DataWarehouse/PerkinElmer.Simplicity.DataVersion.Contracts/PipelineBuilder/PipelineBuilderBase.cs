...
namespace PerkinElmer.Simplicity.Data.Contracts.PipelineBuilder
{
    public abstract class PipelineBuilderBase
    {
        ...
        public (IPropagatorBlock<Tuple<Guid, IList<Guid>>, MigrationDataBase>, Task) CreateProjectEntityIdsPipleline(
        ...
        public (IPropagatorBlock<Guid, MigrationDataBase>, Task) CreateProjectPipleline(MigrationContextBase migrationContextBase)
        {
            var sourceVersion = migrationContextBase.SourceContext.FromReleaseVersion;
            var sourceType = migrationContextBase.SourceContext.SourceType;
            var targetVersion = migrationContextBase.TargetContext.TargetReleaseVersion;
