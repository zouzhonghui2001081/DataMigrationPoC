...
namespace PerkinElmer.Simplicity.Data.Version16.DomainEntities.JsonConverter.Processing
{
    internal class SuitabilityResultJsonConverter : IJsonConverter<ISuitabilityResult>
    {
        ...
        private const string TheoreticalPlatesKeyName = "TheoreticalPlates";
        private const string TheoreticalPlatesNFoleyDorseyKeyName = "TheoreticalPlatesNFoleyDorsey";
        ...
        public JObject ToJson(ISuitabilityResult instance)
        {
            ...
            var jObject = new JObject
            {
                ...
                {TheoreticalPlatesKeyName,  instance.TheoreticalPlatesN== null ? null : JObject.FromObject(instance.TheoreticalPlatesN)},
                {TheoreticalPlatesNFoleyDorseyKeyName,  instance.TheoreticalPlatesNFoleyDorsey== null ? null : JObject.FromObject(instance.TheoreticalPlatesNFoleyDorsey)},
            ...
            {
                jObject.Add(RelativeRetentionTimeKeyName, new JValue(instance.RelativeRetentionTime == null ? null : JObject.FromObject(instance.RelativeRetentionTime)));
            }
            return jObject;
        }
        ...
        public ISuitabilityResult FromJson(JObject jObject)
        {
            ...
            suitabilityResult.TheoreticalPlatesN = jObject[TheoreticalPlatesKeyName].Type == JTokenType.Null ? null : jObject[TheoreticalPlatesKeyName].ToObject<SuitabilityParameterResult>();
            suitabilityResult.TheoreticalPlatesNFoleyDorsey = jObject[TheoreticalPlatesNFoleyDorseyKeyName].Type == JTokenType.Null ? null : jObject[TheoreticalPlatesNFoleyDorseyKeyName].ToObject<SuitabilityParameterResult>();
