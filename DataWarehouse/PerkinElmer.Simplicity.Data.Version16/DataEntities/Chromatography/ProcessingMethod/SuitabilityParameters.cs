...
namespace PerkinElmer.Simplicity.Data.Version16.DataEntities.Chromatography.ProcessingMethod
{
    public class SuitabilityParameters
	{
        ...
        public bool NFoleyDorseyLimitIsUsed { get; set; }
        public double NFoleyDorseyLimitLowerLimit { get; set; }
        public double NFoleyDorseyLimitUpperLimit { get; set; }
        public double NFoleyDorseyLimitRelativeStDevPercent { get; set; }
