...
namespace PerkinElmer.Simplicity.Data.Version15.DataSources.Postgresql.Chromatography
{
    internal class CompoundLibrarySource 
    {
        ...
        public static IList<Version15DataBase> GetCompoundLibrary(Guid projectGuid, PostgresqlSourceContext postgresqlSourceContext)
        {
        ...
        public static IList<Version15DataBase> GetCompoundLibrary(Guid projectGuid, IList<Guid> compoundLibraryGuids, PostgresqlSourceContext postgresqlSourceContext)
        {
            var migrationEntities = new List<Version15DataBase>();
            var compoundLibraryDao = new ProjectCompoundLibraryDao();
            var compoundLibraryItemDao = new CompoundLibraryItemDao();
