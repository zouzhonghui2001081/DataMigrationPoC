...
namespace PerkinElmer.Simplicity.Data.Version15.DataSources.Postgresql.Chromatography
{
    internal class AcquisitionMethodSource 
    {
        ...
        public static IList<Version15DataBase> GetAcqusitionMethods(Guid projectGuid, PostgresqlSourceContext postgresqlSourceContext)
        {
        ...
        public static IList<Version15DataBase> GetAcqusitionMethods(Guid projectGuid, IList<Guid> acquisitionMethodGuids, PostgresqlSourceContext postgresqlSourceContext)
        {
            var migrationEntities = new List<Version15DataBase>();
            var acquisitionMethodDao = new AcquisitionMethodDao();
            using (var connection = new NpgsqlConnection(postgresqlSourceContext.ChromatographyConnectionString))
