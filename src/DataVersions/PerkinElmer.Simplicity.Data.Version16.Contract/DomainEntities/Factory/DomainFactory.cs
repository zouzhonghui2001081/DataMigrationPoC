...
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.LabManagement;
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.Processing;
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.Processing.CompoundLibrary;
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.Processing.SpectralAbsorbanceRatio;
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.ReportBuilder;
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.ReviewApprove;
using PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Implementation.Sequence;
...
using SmoothParameters = PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Interface.Processing.SmoothParameters;


namespace PerkinElmer.Simplicity.Data.Version16.Contract.DomainEntities.Factory
{
    public static class DomainFactory
    {
        ...
        private static readonly IDictionary<Type, Type> DomainTypesImplementation = new Dictionary<Type, Type>
        {
            ...
            {typeof(IChannelIdentifier1), typeof(Implementation.Processing.ChannelIdentifier)},
