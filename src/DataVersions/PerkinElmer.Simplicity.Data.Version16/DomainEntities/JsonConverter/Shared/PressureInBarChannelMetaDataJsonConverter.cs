...
{
    public class PressureInBarChannelMetaDataJsonConverter : IJsonConverter<IPressureChannelMetaData>
    {
        ...
        public JObject ToJson(IPressureChannelMetaData instance)
        {
        ...
        public IPressureChannelMetaData FromJson(JObject jObject)
        {
            ...
            var instance = DomainFactory.Create<IPressureChannelMetaData>();
