...
namespace PerkinElmer.Simplicity.Data.Version16.DomainEntities.Interface.Processing
{
	public interface ISuitabilityResult : ICloneable
    {
        ...
        SuitabilityParameterResult TheoreticalPlatesNFoleyDorsey { get; set; }
	    ...
	    double? ResolutionReferencePeakRetentionTime { get; set; }
	    Guid ResolutionReferencePeakGuid { get; set; }
