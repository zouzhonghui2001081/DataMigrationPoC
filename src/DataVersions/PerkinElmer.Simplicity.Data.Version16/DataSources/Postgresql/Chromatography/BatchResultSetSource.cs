...
namespace PerkinElmer.Simplicity.Data.Version16.DataSources.Postgresql.Chromatography
{
    internal class BatchResultSetSource 
    {
        ...
        public static IList<Version16DataBase> GetBatchResultSets(Guid projectGuid, PostgresqlSourceContext postgresqlSourceContext)
        {
        ...
        public static IList<Version16DataBase> GetBatchResultSets(Guid projectGuid, IList<Guid> batchResultSetGuids, PostgresqlSourceContext postgresqlSourceContext)
        {
            var migrationEntities = new List<Version16DataBase>();
            var batchResultSetDao = new BatchResultSetDao();
            using (var connection = new NpgsqlConnection(postgresqlSourceContext.ChromatographyConnectionString))
