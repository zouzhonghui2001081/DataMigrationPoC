...
namespace PerkinElmer.Simplicity.Data.Version16.DataAccess.Postgresql.Chromatography
{
	internal class CompoundSuitabilitySummaryResultDao
	{
        ...
        internal static string TheoreticalPlatesNFoleyDorseyAverageColumn { get; } = "TheoreticalPlatesNFoleyDorseyAverage";
        internal static string TheoreticalPlatesNFoleyDorseyStDevColumn { get; } = "TheoreticalPlatesNFoleyDorseyStDev";
        internal static string TheoreticalPlatesNFoleyDorseyRelativeStdDevPercentColumn { get; } = "TheoreticalPlatesNFoleyDorseyRelativeStdDevPercent";
        internal static string TheoreticalPlatesNFoleyDorseyRelativeStdDevPassedColumn { get; } = "TheoreticalPlatesNFoleyDorseyRelativeStdDevPassed";
		...
		protected readonly string SelectSql =
            ...
            $"{TableName}.{TheoreticalPlatesNFoleyDorseyAverageColumn}," +
            $"{TableName}.{TheoreticalPlatesNFoleyDorseyStDevColumn}," +
            $"{TableName}.{TheoreticalPlatesNFoleyDorseyRelativeStdDevPercentColumn}," +
            $"{TableName}.{TheoreticalPlatesNFoleyDorseyRelativeStdDevPassedColumn}," +
		...
		protected readonly string InsertSql =
            ...
            $"{TheoreticalPlatesNFoleyDorseyAverageColumn}," +
            $"{TheoreticalPlatesNFoleyDorseyStDevColumn}," +
            $"{TheoreticalPlatesNFoleyDorseyRelativeStdDevPercentColumn}," +
            $"{TheoreticalPlatesNFoleyDorseyRelativeStdDevPassedColumn}," +
