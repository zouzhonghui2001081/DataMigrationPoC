...
{
    public class SolventProportionChannelMetaDataJsonConverter : IJsonConverter<ISolventProportionChannelMetaData>
    {
        ...
        public JObject ToJson(ISolventProportionChannelMetaData instance)
        {
        ...
        public ISolventProportionChannelMetaData FromJson(JObject jObject)
        {
            ...
            var instance = DomainFactory.Create<ISolventProportionChannelMetaData>();
