...
{
    public sealed class ProjectArchiveRetrieveControllers : MigrationControllerBase
    {
        ...
        public override MigrationTypes MigrationType => MigrationTypes.ArchiveRetrieve;
